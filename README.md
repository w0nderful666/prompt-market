...
下面是一段由 Prompt Market 生成的人像提示词，以及对应的出图效果示例。

![Prompt Market 人像提示词生成效果示例](docs/assets/example-portrait.png)

<details>
<summary>查看示例提示词</summary>

```text
1. 这是一张写实摄影风格的 AI 人像提示词画面。
2. 画面主体是女性和男性，姿态自然，表情可信，眼神清晰。
3. 场景位于夜晚街头和公共扶梯。
4. 镜头采用平视人像，亲近自然和俯拍，让人像主体清晰易读，避免尴尬裁切。
5. 光线来自柔光和强烈直闪，在人物面部、发丝、衣物边缘和背景层次上形成细节。
6. 画面带有手机闪光灯等镜头或成像质感，保留可信的真实成像痕迹。
7. 整体画面具有真实照片质感，细节可信和清晰主体，自然皮肤纹理，不过度磨皮，皮肤保留真实纹理，避免塑料感和明显 AI 味。
8. 画面可以略微倾斜，增强随手拍真实感；背景中保留模糊行人、金属台阶和扶手线条；保留轻微噪点、运动模糊、压缩痕迹或日期戳；近距离直闪让皮肤和衣物边缘出现真实反光；背景略微欠曝，路灯和霓虹形成模糊光斑；人物五官保持自然协调，眼神清晰但不过度锐化；皮肤保留真实纹理、毛孔和轻微瑕疵，避免塑料感。

负面提示词：避免畸形手指、多余肢体、错误人体结构，避免水印、文字、logo、签名
```
